...
|-----------:|------------:|--------------:|
|     2.19.2 |    2.19.2.0 |  May 05, 2025 |
|     2.19.1 |    2.19.1.0 |  Mar 04, 2025 |
...
`./bin/opensearch-plugin install https://github.com/hm2thr33/prometheus-exporter-plugin-for-opensearch/releases/download/2.19.2.0/prometheus-exporter-2.19.2.0.zip`
