...
`./bin/opensearch-plugin install https://github.com/hm2thr33/prometheus-exporter-plugin-for-opensearch/releases/download/2.19.1.0/prometheus-exporter-2.19.1.0.zip`
